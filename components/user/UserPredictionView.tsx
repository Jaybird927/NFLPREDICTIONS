...
export default function UserPredictionView({ userId, displayName, authToken }: UserPredictionViewProps) {
  ...
  const [thirtyMinPass, setThirtyMinPass] = useState<{ hasPass: boolean; designatedGameId: number | null; usedGameId: number | null; activeGameId: number | null }>({ hasPass: false, designatedGameId: null, usedGameId: null, activeGameId: null });
